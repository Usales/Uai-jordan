...
function FAQ() {
  return (
    <div style={{ minHeight: '70vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'transparent' }}>
      <div className="faq-container fade-in-up" style={{ background: '#fff', borderRadius: 16, boxShadow: '0 2px 16px rgba(0,0,0,0.08)', padding: '2.5rem 1.5rem', maxWidth: 700, width: '100%', margin: '2.5rem auto', minHeight: 350 }}>
        <h1 style={{ textAlign: 'center', marginBottom: 24, color: '#D72B3D', fontFamily: 'Bebas Neue, Arial, sans-serif', fontSize: '2rem', letterSpacing: 1 }}>❓ Perguntas Frequentes (FAQ)</h1>
