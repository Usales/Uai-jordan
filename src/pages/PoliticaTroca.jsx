...
function PoliticaTroca() {
  return (
    <div style={{ background: '#fff', borderRadius: 12, boxShadow: '0 2px 16px rgba(0,0,0,0.08)', padding: '2.5rem 1.5rem', maxWidth: 700, margin: '2.5rem auto', minHeight: 350 }}>
      <h1 style={{ textAlign: 'center', marginBottom: 24, color: '#D72B3D' }}>🛍️ Política de Troca e Devolução</h1>
      <p style={{ marginBottom: 18, fontWeight: 500 }}>Veja aqui as regras para troca e devolução de produtos comprados na Uai-Jordan.</p>
